        ...
        public async Task<int> AddSale(SalesModel model)
        {
            try
            {
                if (CheckRefNo(model.RefNo))
                {
                    ...
                    entities.SupplierBuyPrice_ExchangeRate_Date = model.SupplierBuyPrice_ExchangeRate_Date;
                    ...
                    entities.Tax_ExchangeRate_Date = model.Tax_ExchangeRate_Date;
                    ...
                    entities.BankCharges_ExchangeRate_Date = model.BankCharges_ExchangeRate_Date;
                    ...
                    entities.LogisticsCost_ExchangeRate_Date = model.LogisticsCost_ExchangeRate_Date;
                    ...
                    entities.LogisticsCost_Local_ExchangeRate_Date = model.LogisticsCost_Local_ExchangeRate_Date;
                    ...
                    entities.UnexpectedCost_ExchangeRate_Date = model.UnexpectedCost_ExchangeRate_Date;
                    ...
                    entities.LossAmountDueToExchange_Rate_ExchangeRate_Date = model.LossAmountDueToExchange_Rate_ExchangeRate_Date;
                    ...
                    entities.MiscellaneousCost_ExchangeRate_Date = model.MiscellaneousCost_ExchangeRate_Date;
                    ...
                    entities.EquipmentAndFacilityRentalFees_ExchangeRate_Date = model.EquipmentAndFacilityRentalFees_ExchangeRate_Date;
                    ...
                    if (model.ProfitAndLoss > 0)
                    {
                        ...
                        if (double.TryParse(model.CommissionPercentageGroup, out double commissionPercentageGroup)
                            && commissionPercentageGroup > 0)
                        {
                        ...
                        else if (double.TryParse(model.CommissionPercentageIndividual,
                            out double commissionPercentageIndiv) && commissionPercentageIndiv > 0)
                        {
                ...
                if (!string.IsNullOrEmpty(model.RefNo))
                {
                    return await _dbContext.Sales.Where(x => x.RefNo == model.RefNo && x.IsDeleted == false)
                        .Select(x => new SalesModel()
                        {
                            ...
                            SupplierBuyPrice_ExchangeRate_Date = x.SupplierBuyPrice_ExchangeRate_Date,
                            ...
                            Tax_ExchangeRate_Date = x.Tax_ExchangeRate_Date,
                            Tax_Note = x.Tax_Note,
                            Tax = x.Tax,
                            ...
                            BankCharges_ExchangeRate_Date = x.BankCharges_ExchangeRate_Date,
                            ...
                            LogisticsCost_ExchangeRate_Date = x.LogisticsCost_ExchangeRate_Date,
                            ...
                            LogisticsCost_Local_ExchangeRate_Date = x.LogisticsCost_Local_ExchangeRate_Date,
                            ...
                            UnexpectedCost_ExchangeRate_Date = x.UnexpectedCost_ExchangeRate_Date,
                            ...
                            LossAmountDueToExchange_Rate_ExchangeRate_Date = x.LossAmountDueToExchange_Rate_ExchangeRate_Date,
                            ...
                            MiscellaneousCost_ExchangeRate_Date = x.MiscellaneousCost_ExchangeRate_Date,
                            ...
                            EquipmentAndFacilityRentalFees_ExchangeRate_Date = x.EquipmentAndFacilityRentalFees_ExchangeRate_Date,
